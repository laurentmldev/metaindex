...
<legend >
	...
	<form 	id="edit.element.<s:property value="selectedCatalog.selectedElement.elementId"/>.details.form" 
		...
		<td><span  ><s:property value="selectedElement.elementId"/></span>
                ...
                <s:iterator value="#curDataset.metadata" var="curMetadata">
                        ...
                        <c:choose>
                                <c:when test="${curMetadata.datatypeId=='1'}" >
                                        <s:include value="/secure/workzone/elementcontents/metadatatypes/workzone.elementcontents.1_WebLink.Details.jsp" >
                                                                        <s:param name="curDataset" value="#curDataset" />
                                                                        <s:param name="curMetadata" value="#curMetadata" />
                                        </s:include>
                                </c:when>
                                <c:when test="${curMetadata.datatypeId=='4'}" >                                
                                        <s:include value="/secure/workzone/elementcontents/metadatatypes/workzone.elementcontents.4_Image.Details.jsp" >
                                                                        <s:param name="curDataset" value="#curDataset" />
                                                                        <s:param name="curMetadata" value="#curMetadata" />
                                        </s:include>
                                </c:when>
                                <c:when test="${curMetadata.datatypeId=='5'}" >
                                        <s:include value="/secure/workzone/elementcontents/metadatatypes/workzone.elementcontents.5_LongText.Details.jsp" >
                                                                        <s:param name="curDataset" value="#curDataset" />
                                                                        <s:param name="curMetadata" value="#curMetadata" />
                                        </s:include>
                                </c:when>
                                <c:when test="${curMetadata.datatypeId=='6'}" >
                                        <s:include value="/secure/workzone/elementcontents/metadatatypes/workzone.elementcontents.6_Number.Details.jsp" >
                                                                        <s:param name="curDataset" value="#curDataset" />
                                                                        <s:param name="curMetadata" value="#curMetadata" />
                                        </s:include>
                                </c:when>
                                <c:when test="${curMetadata.datatypeId=='10'}" >
                                        <s:include value="/secure/workzone/elementcontents/metadatatypes/workzone.elementcontents.10_TinyText.Details.jsp" >
                                                                        <s:param name="curDataset" value="#curDataset" />
                                                                        <s:param name="curMetadata" value="#curMetadata" />
                                        </s:include>
                                </c:when>
