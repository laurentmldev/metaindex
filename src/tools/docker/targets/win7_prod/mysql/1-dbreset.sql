...
`catalog_term_id` int(11) NOT NULL,
  `catalog_id` int(11) NOT NULL,
  -- this list shall be coherent with ICatalogTerm.TERM_DATATYPE enum definition.
  `datatype` ENUM('TINY_TEXT', 'RICH_TEXT', 'DATE', 'INTEGER', 'FLOAT', 'LINK_URL', 'IMAGE_URL', 'AUDIO_URL', 'VIDEO_URL', 'GEO_POINT') ,
...
CREATE TABLE `catalog_perspectives` (
  `catalog_perspective_id` int(11) NOT NULL,
  `catalog_id` int(11) NOT NULL,
  `name` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `perspective_json_string` varchar(2018) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `lastUpdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5 ;
...
CREATE TABLE `catalog_terms_vocabulary` (
  `catalog_terms_vocabulary_id` int(11) NOT NULL,
  `catalog_term_id` int(11) NOT NULL,
...
`catalog_vocabulary_id` int(11) NOT NULL,
  `catalog_id` int(11) NOT NULL,
  `guilanguage_id` int(11) NOT NULL,
...
`user_catalogs_rights_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `catalog_id` int(11) NOT NULL,
...
`user_catalogs_customization_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `catalog_id` int(11) NOT NULL,
...
--
ALTER TABLE `catalogs`
MODIFY `catalog_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1004;

--
-- AUTO_INCREMENT pour la table `catalog_terms`
--
ALTER TABLE `catalog_terms`
MODIFY `catalog_term_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
...
--
ALTER TABLE `catalog_perspectives`
MODIFY `catalog_perspective_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
...
--
ALTER TABLE `catalog_terms_vocabulary`
MODIFY `catalog_terms_vocabulary_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT pour la table `catalog_vocabulary`
--
ALTER TABLE `catalog_vocabulary`
MODIFY `catalog_vocabulary_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `user_catalogs_rights`
MODIFY `user_catalogs_rights_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT pour la table `user_catalogs_customization`
--
ALTER TABLE `user_catalogs_customization`
MODIFY `user_catalogs_customization_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
