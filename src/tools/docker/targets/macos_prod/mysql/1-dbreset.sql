...
select '######## SETTING UP METAINDEX SQL DATABASE ########' as '';
...
`catalog_id` int(16) NOT NULL,
  ...
  `quotaNbDocs` int(64) NOT NULL DEFAULT '200',
  
  /* maximum disk space used by this catalogs's FTP data in bytes*/
  `quotaFtpDiscSpaceBytes` int(16) NOT NULL DEFAULT '1000',
  
  `lastUpdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=9000 ;
...
`catalog_term_id` int(16) NOT NULL,
  `catalog_id` int(16) NOT NULL,
  -- this list shall be coherent with ICatalogTerm.TERM_DATATYPE enum definition.
  `datatype` ENUM('TINY_TEXT', 'RICH_TEXT', 'DATE', 'INTEGER', 'FLOAT', 'LINK_URL', 'IMAGE_URL', 'AUDIO_URL', 'VIDEO_URL', 'GEO_POINT','RELATION','REFERENCE') ,
...
CREATE TABLE `catalog_perspectives` (
  `catalog_perspective_id` int(16) NOT NULL,
  `catalog_id` int(16) NOT NULL,
  `name` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `catalog_terms_vocabulary` (
  `catalog_terms_vocabulary_id` int(16) NOT NULL,
  `catalog_term_id` int(16) NOT NULL,
  `guilanguage_id` int(16) NOT NULL,
...
`catalog_vocabulary_id` int(16) NOT NULL,
  `catalog_id` int(16) NOT NULL,
  `guilanguage_id` int(16) NOT NULL,
...
(1, 'Silver Stone', 'silver', '0000-00-00 00:00:00'),
(2, 'Green Earth', 'greenearth', '0000-00-00 00:00:00'),
(3, 'Deep Blue', 'deepblue', '0000-00-00 00:00:00');
...
`user_id` int(16) NOT NULL,
  ...
  `guilanguage_id` int(16) NOT NULL DEFAULT '1',
  `guitheme_id` int(16) NOT NULL DEFAULT '1',  
  `lastUpdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
`user_catalogs_rights_id` int(16) NOT NULL,
  `user_id` int(16) NOT NULL,
  `catalog_id` int(16) NOT NULL,
...
`user_catalogs_customization_id` int(16) NOT NULL,
  `user_id` int(16) NOT NULL,
  `catalog_id` int(16) NOT NULL,
...
ALTER TABLE `user_roles`
 ADD PRIMARY KEY (`user_role_id`), ADD UNIQUE KEY `uni_userid_role` (`role`,`user_id`), 
 	...
 	ADD KEY `fk_catalogid_idx` (`catalog_id`);
...
--
ALTER TABLE `catalogs`
MODIFY `catalog_id` int(16) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1004;

--
-- AUTO_INCREMENT pour la table `catalog_terms`
--
ALTER TABLE `catalog_terms`
MODIFY `catalog_term_id` int(16) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
...
--
ALTER TABLE `catalog_perspectives`
MODIFY `catalog_perspective_id` int(16) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
...
--
ALTER TABLE `filters`
MODIFY `filter_id` int(16) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `catalog_terms_vocabulary`
--
ALTER TABLE `catalog_terms_vocabulary`
MODIFY `catalog_terms_vocabulary_id` int(16) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT pour la table `catalog_vocabulary`
--
ALTER TABLE `catalog_vocabulary`
MODIFY `catalog_vocabulary_id` int(16) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT pour la table `guilanguages`
--
ALTER TABLE `guilanguages`
MODIFY `guilanguage_id` int(16) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pour la table `guithemes`
--
ALTER TABLE `guithemes` 
MODIFY `guitheme_id` int(16) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `user_roles`
MODIFY `user_role_id` int(16) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT pour la table `user_catalogs_rights`
--
ALTER TABLE `user_catalogs_rights`
MODIFY `user_catalogs_rights_id` int(16) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT pour la table `user_catalogs_customization`
--
ALTER TABLE `user_catalogs_customization`
MODIFY `user_catalogs_customization_id` int(16) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
