...
<div class="d-sm-flex align-items-center justify-content-between mb-1">
	...
	<table><tr>
		...
		<td><div id="MxGui.details.viewMode" title="<s:text name="global.toggleViewMode"/>" style="display:none"> <i id=""  class="mx-help-icon far fa-list-alt"  style="font-size:1.4rem;"></i></div></td>
		...
		<td><div  onclick="_details_next();"> <i id="details_next_arrow"  class="mx-history-disabled-nav-button mx-help-icon far fa-caret-right"  style="display:none;font-weight:bold;font-size:2rem;"></i></div></td>
