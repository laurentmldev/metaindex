...
<s:include value="/secure/subparts/workzone.contents.javascript.jsp" ></s:include>
...
<!-- Modal window for Delete Dataset -->
 ...
 <!-- Modal window for Delete Metadata -->
    ...
    <div onclick="if (editModeActive) { deselectAll(); }" >
	    		...
	    		<s:include value="/secure/subparts/workzone.contents.dropzone.dataset.jsp" >
 								<s:param name="dropPosition" value="1" />		 															 									    											    						
				</s:include>		   				
	    	    <s:iterator value="selectedCatalog.selectedElement.datasets" var="curDataset">
					<s:include value="/secure/subparts/workzone.contents.dataset.jsp" >
