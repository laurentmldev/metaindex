...
import metaindex.app.periodic.statistics.publicpages.TutosPageMxStat;
 ...
 * @author Laurent ML
 */
public class BeanTutorials extends AMetaindexBean {  
	...
	@Override
  	public String execute() throws Exception {
		Globals.GetStatsMgr().handleStatItem(new TutosPageMxStat(this.getCurrentUserProfile()));
